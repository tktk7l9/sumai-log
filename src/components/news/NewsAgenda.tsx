...
/** AgendaView の noEvents だけ上書きする（カレンダーの「予定はありません」は変えない） */
const NEWS_AGENDA_LABELS: AgendaViewProps['labels'] = {
  ...SCHEDULE_LABELS_JA,
  noEvents: 'お知らせはありません',
}
 ...
 */
export function NewsAgenda({ items }: { items: NewsEventRow[] }) {
